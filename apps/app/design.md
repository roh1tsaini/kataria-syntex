...
| Full  | `Kataria Syntex Biz App` | document `<title>`, PWA manifest `name`, installer/product names (Electron, Android strings), auth header, release names |
