/** Number/date formatting — the RN port of apps/app's ui/lib/format. */
...
/** A Date as YYYY-MM-DD in the device timezone (never UTC — entries created
 * after midnight IST must not be filed under yesterday). */
